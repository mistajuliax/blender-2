...
# ------------------------------------------------------------------
class WINPANEL(bpy.types.Operator):
        ...
        for x in range(0, mx):
            if kx[x][y] is True:
                ...
                for i in range(0, res):
                    ...
                    y2 = -math.cos(a) * k
                    if x1 < y1 < x2:
                        myvertex.extend([[y1, fr - k2 / 2, math.sin(a) * r + z], [y1, fr + k2 / 2, math.sin(a) * r
                                                                                  + z]])
                        t1.append(len(myvertex) - 2)
                        t2.append(len(myvertex) - 1)
                    if x1 + k2 < y2 < x2 - k2:
                        myvertex.extend([[y2, fr - k2 / 2, math.sin(a) * k + z], [y2, fr + k2 / 2, math.sin(a) * k
                                                                                  + z]])
            ...
            for i in range(0, res):
                ...
                if x1 < y1 < x2:
                    ...
                    ar.append(n - 2)
            myvertex.extend(
                [[x1, fr - 0.005, math.sqrt(k ** 2 - x1 ** 2) + z], [x1, fr + 0.005, math.sqrt(k ** 2 - x1 ** 2) + z]])
            ...
            myvertex.extend(
                [[x2, fr - 0.005, math.sqrt(k ** 2 - x2 ** 2) + z], [x2, fr + 0.005, math.sqrt(k ** 2 - x2 ** 2) + z]])
            n = len(myvertex)
...
bpy.types.Object.WindowPanelGenerator = bpy.props.CollectionProperty(type=GeneralProperties)
